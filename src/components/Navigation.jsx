...
<div className={`w-21 h-21 justify-self-end p-3 m-4`} onClick={previewCart}><img className="w-full h-full" src={shoppingCart} alt="shopping cart icon" title="FontAwsome" />{cart.length > 0 && (<span className="text-white block relative w-7 h-7 bottom-17 left-5 bg-blue-500 rounded-full text-center text-base font-bold">{cartCount}</span>) }</div>
