...
<p>{product.name}</p>
<div className="flex justify-between"><p className="font-bold p-2">{product.qty}<span className="font-normal"> x {product.price}</span></p> <span className="pl-3 pr-3 p-2 font-bold cursor-pointer" onClick={()=>removeFromCart(product)}>x</span></div>
